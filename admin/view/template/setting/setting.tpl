...
<div id="content">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="text" name="config_novaposhta_key" value="config_novaposhta_key 1" placeholder="<?php echo $entry_name; ?>" id="input-name" class="form-control" />
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-email">Viber</label>
                <div class="col-sm-10">
                  <input type="text" name="config_viber" value="<?php echo $config_viber; ?>" placeholder="Skype" id="input-email" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-email">Skype</label>
                <div class="col-sm-10">
                  <input type="text" name="config_skype" value="<?php echo $config_skype; ?>" placeholder="Skype" id="input-email" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-telephone">WhatsApp</label>
                <div class="col-sm-10">
                  <input type="text" name="config_telephone_5" value="<?php echo $config_telephone_5; ?>" placeholder="<?php echo $entry_telephone; ?> 5" id="input-telephone" class="form-control" />
                </div>
              </div>
              <div class="form-group required">
              ...
              <div class="form-group ">
                ...
                <div class="col-sm-10">
                  <input type="text" name="config_telephone_2" value="<?php echo $config_telephone_2; ?>" placeholder="<?php echo $entry_telephone; ?> 2" id="input-telephone" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-telephone"><?php echo $entry_telephone; ?> 3</label>
                <div class="col-sm-10">
                  <input type="text" name="config_telephone_3" value="<?php echo $config_telephone_3; ?>" placeholder="<?php echo $entry_telephone; ?> 3" id="input-telephone" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-telephone"><?php echo $entry_telephone; ?> 4</label>
                <div class="col-sm-10">
                  <input type="text" name="config_telephone_4" value="<?php echo $config_telephone_4; ?>" placeholder="<?php echo $entry_telephone; ?> 4" id="input-telephone" class="form-control" />
                </div>
              </div>

              <hr>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-vk">Ссылка vk</label>
                <div class="col-sm-10">
                  <input type="text" name="config_vk" value="<?php echo $config_vk; ?>" placeholder="Ссылка vk" id="input-vk" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-fb">Ссылка Facebook</label>
                <div class="col-sm-10">
                  <input type="text" name="config_facebook" value="<?php echo $config_facebook; ?>" placeholder="Ссылка facebook" id="input-fb" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-fb">Ссылка Instagram</label>
                <div class="col-sm-10">
                  <input type="text" name="config_instagram" value="<?php echo $config_instagram; ?>" placeholder="Ссылка facebook" id="input-fb" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-tw">Ссылка Twitter</label>
                <div class="col-sm-10">
                  <input type="text" name="config_twitter" value="<?php echo $config_twitter; ?>" placeholder="Ссылка twitter" id="input-tw" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-gplus">Ссылка Vimeo</label>
                <div class="col-sm-10">
                  <input type="text" name="config_vimeo" value="<?php echo $config_vimeo; ?>" placeholder="Ссылка gplus" id="input-gplus" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-google">Ссылка Google+</label>
                <div class="col-sm-10">
                  <input type="text" name="config_google" value="<?php echo $config_google; ?>" placeholder="Ссылка Google+" id="input-google" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-odnoklassniki">Ссылка Однокласники</label>
                <div class="col-sm-10">
                  <input type="text" name="config_odnoklassniki" value="<?php echo $config_odnoklassniki; ?>" placeholder="Ссылка Однокласники" id="input-odnoklassniki" class="form-control" />
                </div>
              </div>
              <hr>
              <div class="form-group">
            ...
            <div class="tab-pane" id="tab-store">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-seo-image">SEO изображение</label>
                <div class="col-sm-10"><a href="" id="thumb-seo-image" data-toggle="image" class="img-thumbnail"><img src="<?php echo $thumb_seo; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                  <input type="hidden" name="config_seo_image" value="<?php echo $config_seo_image; ?>" id="input-seo-image" />
                </div>
              </div>
              ...
              <div class="tab-content">
                <?php foreach ($languages as $language) { ?>
                  <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                    <div class="form-group">
                      <label class="col-sm-2 control-label" for="input-title-seotext<?php echo $language['language_id']; ?>">заголовок SEO описания</label>
                      <div class="col-sm-10">
                        <input type="text" name="config_title_seo_text_<?php echo $language['code']; ?>" value="<?php echo isset($config_title_seo_text[$language['code']]) ? $config_title_seo_text[$language['code']] : ''; ?>" placeholder="заголовок SEO описания" id="input-title-seotext<?php echo $language['language_id']; ?>" class="form-control" />
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label" for="input-seotext<?php echo $language['language_id']; ?>">SEO описание</label>
                      <div class="col-sm-10">
                        <textarea name="config_seo_text_<?php echo $language['code']; ?>" rows="10" placeholder="SEO описание" id="input-seotext<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($config_seo_text[$language['code']]) ? $config_seo_text[$language['code']] : ''; ?></textarea>
                      </div>
                    </div>
                  </div>
                <?php } ?>
            ...
            <div class="tab-pane" id="tab-option">
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $text_catagory_product_text; ?>"><?php echo $text_catagory_product; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                      <?php if ($config_catagory_product) { ?>
                        <input type="radio" name="config_catagory_product" value="1" checked="checked" />
                        <?php echo $text_yes; ?>
                      <?php } else { ?>
                        <input type="radio" name="config_catagory_product" value="1" />
                        <?php echo $text_yes; ?>
                      <?php } ?>
                    </label>
                    <label class="radio-inline">
                      <?php if (!$config_catagory_product) { ?>
                        <input type="radio" name="config_catagory_product" value="0" checked="checked" />
                        <?php echo $text_no; ?>
                      <?php } else { ?>
                        <input type="radio" name="config_catagory_product" value="0" />
                        <?php echo $text_no; ?>
                      <?php } ?>
                    </label>
                  </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $text_catagory_product_position_text; ?>"><?php echo $text_catagory_product_position; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                      <?php if ($config_catagory_product_position) { ?>
                        <input type="radio" name="config_catagory_product_position" value="1" checked="checked" />
                        <?php echo $text_yes; ?>
                      <?php } else { ?>
                        <input type="radio" name="config_catagory_product_position" value="1" />
                        <?php echo $text_yes; ?>
                      <?php } ?>
                    </label>
                    <label class="radio-inline">
                      <?php if (!$config_catagory_product_position) { ?>
                        <input type="radio" name="config_catagory_product_position" value="0" checked="checked" />
                        <?php echo $text_no; ?>
                      <?php } else { ?>
                        <input type="radio" name="config_catagory_product_position" value="0" />
                        <?php echo $text_no; ?>
                      <?php } ?>
                    </label>
                  </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $text_catagory_product_child_text; ?>"><?php echo $text_catagory_product_child; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                      <?php if ($config_catagory_product_child) { ?>
                        <input type="radio" name="config_catagory_product_child" value="1" checked="checked" />
                        <?php echo $text_yes; ?>
                      <?php } else { ?>
                        <input type="radio" name="config_catagory_product_child" value="1" />
                        <?php echo $text_yes; ?>
                      <?php } ?>
                    </label>
                    <label class="radio-inline">
                      <?php if (!$config_catagory_product_child) { ?>
                        <input type="radio" name="config_catagory_product_child" value="0" checked="checked" />
                        <?php echo $text_no; ?>
                      <?php } else { ?>
                        <input type="radio" name="config_catagory_product_child" value="0" />
                        <?php echo $text_no; ?>
                      <?php } ?>
                    </label>
                  </div>
              ...
              <fieldset>
                <legend>SEO</legend>
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="Редеректить на полный урл товара">Обработка URL</span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                      <?php if ($config_seo_url_my) { ?>
                        <input type="radio" name="config_seo_url_my" value="1" checked="checked" />
                        <?php echo $text_yes; ?>
                      <?php } else { ?>
                        <input type="radio" name="config_seo_url_my" value="1" />
                        <?php echo $text_yes; ?>
                      <?php } ?>
                    </label>
                    <label class="radio-inline">
                      <?php if (!$config_seo_url_my) { ?>
                        <input type="radio" name="config_seo_url_my" value="0" checked="checked" />
                        <?php echo $text_no; ?>
                      <?php } else { ?>
                        <input type="radio" name="config_seo_url_my" value="0" />
                        <?php echo $text_no; ?>
                      <?php } ?>
                    </label>
                  </div>
            ...
            <div class="tab-pane" id="tab-mail">
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-mail-logo">Логотип для почты</label>
                <div class="col-sm-10"><a href="" id="thumb-mail-logo" data-toggle="image" class="img-thumbnail"><img src="<?php echo $mail_logo; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                  <input type="hidden" name="config_mail_logo" value="<?php echo $config_mail_logo; ?>" id="input-mail-logo" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-mail-background">Фон под логотип</label>
                <div class="col-sm-10"><a href="" id="thumb-mail-background" data-toggle="image" class="img-thumbnail"><img src="<?php echo $mail_background; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                  <input type="hidden" name="config_mail_background" value="<?php echo $config_mail_background; ?>" id="input-mail-background" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-mail-background-footer">Фон под логотип</label>
                <div class="col-sm-10"><a href="" id="thumb-mail-background-footer" data-toggle="image" class="img-thumbnail"><img src="<?php echo $mail_background_footer; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                  <input type="hidden" name="config_mail_background_footer" value="<?php echo $config_mail_background_footer; ?>" id="input-mail-background-footer" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-mail-color-text">Цвет текста</label>
                <div class="col-sm-10">
                  <input type="color" name="config_mail_color_text" id="input-mail-color-text" value="<?php echo $config_mail_color_text; ?>" style="background: #fff;border: 1px solid #DDD;border-radius: 4px;padding: 1px 4px;width: 40px;height: 30px;margin-top: 4px;">
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-mail-color-background">Цвет фона</label>
                <div class="col-sm-10">
                  <input type="color" name="config_mail_color_background" id="input-mail-color-background"  value="<?php echo $config_mail_color_background; ?>" style="background: #fff;border: 1px solid #DDD;border-radius: 4px;padding: 1px 4px;width: 40px;height: 30px;margin-top: 4px;">
                </div>
              </div>
              <hr>
              <div class="form-group">
            ...
            <div class="tab-pane" id="tab-cart">
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-schedule"><?php echo $entry_open; ?></label>
                <div class="col-sm-10">
                  <textarea name="config_cart_schedule" placeholder="<?php echo $entry_open; ?>" id="input-schedule" class="form-control"><?php echo $config_cart_schedule; ?></textarea>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-description-shipping"><?php echo $entry_description_shipping; ?></label>
                <div class="col-sm-10">
                  <textarea name="config_cart_description_shipping" placeholder="<?php echo $entry_description_shipping; ?>" id="input-description-shipping" class="form-control"><?php echo $config_cart_description_shipping; ?></textarea>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-description-payment"><?php echo $entry_description_payment; ?></label>
                <div class="col-sm-10">
                  <textarea name="config_cart_description_payment" placeholder="<?php echo $entry_description_payment; ?>" id="input-description-payment" class="form-control"><?php echo $config_cart_description_payment; ?></textarea>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-description-comment"><?php echo $entry_description_comment; ?></label>
                <div class="col-sm-10">
                  <textarea name="config_cart_description_comment" placeholder="<?php echo $entry_description_comment; ?>" id="input-description-comment" class="form-control"><?php echo $config_cart_description_comment; ?></textarea>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-description-promo"><?php echo $entry_description_promo; ?></label>
                <div class="col-sm-10">
                  <textarea name="config_cart_description_promo" placeholder="<?php echo $entry_description_promo; ?>" id="input-description-promo" class="form-control"><?php echo $config_cart_description_promo; ?></textarea>
                </div>
              </div>
            </div>
          </div>
  ...
  <script type="text/javascript"><!--
    ...
    <?php foreach ($languages as $language) { ?>
    $('#input-seotext<?php echo $language['language_id']; ?>').summernote({height: 300});
    <?php } ?>
  //--></script>

  <script type="text/javascript"><!--
    $('#input-schedule').summernote({ height: 300 });
    $('#input-description-shipping').summernote({ height: 300 });
    $('#input-description-payment').summernote({ height: 300 });
    $('#input-description-comment').summernote({ height: 300 });
    $('#input-description-promo').summernote({ height: 300 });
  //--></script>
  <script type="text/javascript"><!--
