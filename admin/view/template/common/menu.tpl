<ul id="menu">
  ...
  <?php if( $has_permission->hasPermission('access','catalog/product') || $has_permission->hasPermission('access','catalog/category') ): ?><li id="catalog"><a class="parent"><i class="fa fa-tags fa-fw"></i> <span><?php echo $text_catalog; ?></span></a>
    <ul>
      <?php if($has_permission->hasPermission('access','catalog/service')): ?><li><a href="<?php echo $service; ?>">Категории услуг</a></li><?php endif; ?>
      <?php if($has_permission->hasPermission('access','catalog/sproduct')): ?><li><a href="<?php echo $sproduct; ?>">Услуги</a></li><?php endif; ?>
      ...
      <?php if($has_permission->hasPermission('access','catalog/vacansy')): ?><li><a href="<?php echo $link_vacansy; ?>">Вакансии</a></li> <?php endif;?>
      ...
      <?php if($has_permission->hasPermission('access','catalog/reviews')): ?><li><a href="<?php echo $reviews; ?>"><?php echo $text_review; ?></a></li> <?php endif;?>
  ...
  <li id="extension">
    <a class="parent"><i class="fa fa-comments-o"></i> <span>Помощь</span></a>
    <ul>
