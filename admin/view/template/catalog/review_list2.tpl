          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'r.author') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php if ($sort == 'answer_new') { ?>
                    <a href="<?php echo $sort_answer; ?>" class="<?php echo strtolower($order); ?>">Непромодерированные ответы</a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_answer; ?>">Непромодерированные ответы</a>
                    <?php } ?></td>	
              ...
              <tbody>
                ...
                <tr <?php if($review['answer_new']){ ?> style="background-color: #FFAAAA;" <?php } ?>>
				  ...
				  <td class="text-left"><?php echo $review['answer_new']; ?></td>
