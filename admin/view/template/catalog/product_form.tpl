        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea name="product_description[<?php echo $language['language_id']; ?>][description_short]" placeholder="<?php echo $entry_description_short; ?>" id="input-description-short<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['description_short'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group required">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-image">Фоновое изображение крошек</label>
                <div class="col-sm-10">
                  <a href="" id="thumb-bg-image" data-toggle="image" class="img-thumbnail"><img src="<?php echo $thumb_bg; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                  <input type="hidden" name="image_bg" value="<?php echo $image_bg; ?>" id="input-bg-image" />
                </div>
              </div>
              <div class="form-group required">
            ...
            <div class="tab-pane" id="tab-video">
              <div class="form-group">
                <label class="col-lg-2 control-label" for="input-video"><span data-toggle="tooltip" title="">Ссылка на видео</span></label>
                <div class="col-lg-10">
                  <input type="text" name="video" value="<?php echo $video; ?>" placeholder="ссылка на видео" id="input-video" class="form-control" />
                </div>
              </div>
            </div>
