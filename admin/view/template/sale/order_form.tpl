...
<!--              </div>-->
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-shipping-company">Курьерская служба</label>
                <div class="col-sm-10">
                  <input type="text" name="company" value="<?php echo $shipping_company; ?>" id="input-shipping-company" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-shipping-postcode">ТТН курьерской службы</label>
                <div class="col-sm-10">
