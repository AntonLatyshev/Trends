...
class ControllerCatalogCategory extends Controller {
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			if (!empty($this->request->post['custom_field'])) {
				...
				$this->model_catalog_category->editCustomFields($this->request->get['category_id'], $json_custom_fields);
			} else {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['custom_field'])) {
			...
			$custom_fields = $this->model_catalog_category->getCategoryCustomFields($this->request->get['category_id']);
		...
		if (isset($this->request->post['image_bg'])) {
			...
			$data['image_bg'] = $category_info['image_bg'];
		} else {
			$data['image_bg'] = '';
		}
		...
		} elseif (!empty($category_info) && is_file(DIR_IMAGE . $category_info['image_bg'])) {
			$data['thumb_bg'] = $this->model_tool_image->resize($category_info['image_bg'], 100, 100);
		} else {
