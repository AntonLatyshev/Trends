...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['text_catagory_product'] = $this->language->get('text_catagory_product');
		$data['text_catagory_product_text'] = $this->language->get('text_catagory_product_text');
		$data['text_catagory_product_position'] = $this->language->get('text_catagory_product_position');
		$data['text_catagory_product_position_text'] = $this->language->get('text_catagory_product_position_text');
		$data['text_catagory_product_child'] = $this->language->get('text_catagory_product_child');
		$data['text_catagory_product_child_text'] = $this->language->get('text_catagory_product_child_text');
		...
		$data['entry_description_shipping'] = $this->language->get('entry_description_shipping');
		$data['entry_description_payment'] = $this->language->get('entry_description_payment');
		$data['entry_description_comment'] = $this->language->get('entry_description_comment');
		$data['entry_description_promo'] = $this->language->get('entry_description_promo');
		...
		if (isset($this->request->post['config_telephone_5'])) {
			$data['config_telephone_5'] = $this->request->post['config_telephone_5'];
		} else {
			$data['config_telephone_5'] = $this->config->get('config_telephone_5');
		}
		...
		if (isset($this->request->post['config_vimeo'])) {
			$data['config_vimeo'] = $this->request->post['config_vimeo'];
		} else {
		...
		if (isset($this->request->post['config_odnoklassniki'])) {
			$data['config_odnoklassniki'] = $this->request->post['config_odnoklassniki'];
		} else {
		...
		// Адресса
			// Киев
		if (isset($this->request->post['config_address_kiev'])) {
			$data['config_address_kiev'] = $this->request->post['config_address_kiev'];
		} else {
			$data['config_address_kiev'] = $this->config->get('config_address_kiev');
		}

		if (isset($this->request->post['config_address_kiev_phone'])) {
			$data['config_address_kiev_phone'] = $this->request->post['config_address_kiev_phone'];
		} else {
			$data['config_address_kiev_phone'] = $this->config->get('config_address_kiev_phone');
		}

		if (isset($this->request->post['config_address_kiev_phone_2'])) {
			$data['config_address_kiev_phone_2'] = $this->request->post['config_address_kiev_phone_2'];
		} else {
			$data['config_address_kiev_phone_2'] = $this->config->get('config_address_kiev_phone_2');
		}

		if (isset($this->request->post['config_address_kiev_phone_3'])) {
			$data['config_address_kiev_phone_3'] = $this->request->post['config_address_kiev_phone_3'];
		} else {
			$data['config_address_kiev_phone_3'] = $this->config->get('config_address_kiev_phone_3');
		}

		if (isset($this->request->post['config_address_kiev_mail'])) {
			$data['config_address_kiev_mail'] = $this->request->post['config_address_kiev_mail'];
		} else {
			$data['config_address_kiev_mail'] = $this->config->get('config_address_kiev_mail');
		}

		if (isset($this->request->post['config_address_kiev_mail_2'])) {
			$data['config_address_kiev_mail_2'] = $this->request->post['config_address_kiev_mail_2'];
		} else {
			$data['config_address_kiev_mail_2'] = $this->config->get('config_address_kiev_mail_2');
		}

			// Львов
		if (isset($this->request->post['config_address_lviv'])) {
			$data['config_address_lviv'] = $this->request->post['config_address_lviv'];
		} else {
			$data['config_address_lviv'] = $this->config->get('config_address_lviv');
		}

		if (isset($this->request->post['config_address_lviv_phone'])) {
			$data['config_address_lviv_phone'] = $this->request->post['config_address_lviv_phone'];
		} else {
			$data['config_address_lviv_phone'] = $this->config->get('config_address_lviv_phone');
		}

		if (isset($this->request->post['config_address_lviv_phone_2'])) {
			$data['config_address_lviv_phone_2'] = $this->request->post['config_address_lviv_phone_2'];
		} else {
			$data['config_address_lviv_phone_2'] = $this->config->get('config_address_lviv_phone_2');
		}

		if (isset($this->request->post['config_address_lviv_phone_3'])) {
			$data['config_address_lviv_phone_3'] = $this->request->post['config_address_lviv_phone_3'];
		} else {
			$data['config_address_lviv_phone_3'] = $this->config->get('config_address_lviv_phone_3');
		}

		if (isset($this->request->post['config_address_lviv_mail'])) {
			$data['config_address_lviv_mail'] = $this->request->post['config_address_lviv_mail'];
		} else {
			$data['config_address_lviv_mail'] = $this->config->get('config_address_lviv_mail');
		}

		if (isset($this->request->post['config_address_lviv_mail_2'])) {
			$data['config_address_lviv_mail_2'] = $this->request->post['config_address_lviv_mail_2'];
		} else {
			$data['config_address_lviv_mail_2'] = $this->config->get('config_address_lviv_mail_2');
		}

			// Ивано-Франковск
		if (isset($this->request->post['config_address_ivano_frank'])) {
			$data['config_address_ivano_frank'] = $this->request->post['config_address_ivano_frank'];
		} else {
			$data['config_address_ivano_frank'] = $this->config->get('config_address_ivano_frank');
		}

		if (isset($this->request->post['config_address_ivano_frank_phone'])) {
			$data['config_address_ivano_frank_phone'] = $this->request->post['config_address_ivano_frank_phone'];
		} else {
			$data['config_address_ivano_frank_phone'] = $this->config->get('config_address_ivano_frank_phone');
		}

		if (isset($this->request->post['config_address_ivano_frank_phone_2'])) {
			$data['config_address_ivano_frank_phone_2'] = $this->request->post['config_address_ivano_frank_phone_2'];
		} else {
			$data['config_address_ivano_frank_phone_2'] = $this->config->get('config_address_ivano_frank_phone_2');
		}

		if (isset($this->request->post['config_address_ivano_frank_phone_3'])) {
			$data['config_address_ivano_frank_phone_3'] = $this->request->post['config_address_ivano_frank_phone_3'];
		} else {
			$data['config_address_ivano_frank_phone_3'] = $this->config->get('config_address_ivano_frank_phone_3');
		}

		if (isset($this->request->post['config_address_ivano_frank_mail'])) {
			$data['config_address_ivano_frank_mail'] = $this->request->post['config_address_ivano_frank_mail'];
		} else {
			$data['config_address_ivano_frank_mail'] = $this->config->get('config_address_ivano_frank_mail');
		}

		if (isset($this->request->post['config_address_ivano_frank_mail_2'])) {
			$data['config_address_ivano_frank_mail_2'] = $this->request->post['config_address_ivano_frank_mail_2'];
		} else {
			$data['config_address_ivano_frank_mail_2'] = $this->config->get('config_address_ivano_frank_mail_2');
		}


			// Баку
		if (isset($this->request->post['config_address_baku'])) {
			$data['config_address_baku'] = $this->request->post['config_address_baku'];
		} else {
			$data['config_address_baku'] = $this->config->get('config_address_baku');
		}

		if (isset($this->request->post['config_address_baku_phone'])) {
			$data['config_address_baku_phone'] = $this->request->post['config_address_baku_phone'];
		} else {
			$data['config_address_baku_phone'] = $this->config->get('config_address_baku_phone');
		}

		if (isset($this->request->post['config_address_baku_phone_2'])) {
			$data['config_address_baku_phone_2'] = $this->request->post['config_address_baku_phone_2'];
		} else {
			$data['config_address_baku_phone_2'] = $this->config->get('config_address_baku_phone_2');
		}

		if (isset($this->request->post['config_address_baku_phone_3'])) {
			$data['config_address_baku_phone_3'] = $this->request->post['config_address_baku_phone_3'];
		} else {
			$data['config_address_baku_phone_3'] = $this->config->get('config_address_baku_phone_3');
		}

		if (isset($this->request->post['config_address_baku_mail'])) {
			$data['config_address_baku_mail'] = $this->request->post['config_address_baku_mail'];
		} else {
			$data['config_address_baku_mail'] = $this->config->get('config_address_baku_mail');
		}

		if (isset($this->request->post['config_address_baku_mail_2'])) {
			$data['config_address_baku_mail_2'] = $this->request->post['config_address_baku_mail_2'];
		} else {
			$data['config_address_baku_mail_2'] = $this->config->get('config_address_baku_mail_2');
		}
		...
		// Image for E-mail
		if (isset($this->request->post['config_mail_logo'])) {
			$data['config_mail_logo'] = $this->request->post['config_mail_logo'];
		} else {
			$data['config_mail_logo'] = $this->config->get('config_mail_logo');
		}

		if (isset($this->request->post['config_mail_logo']) && is_file(DIR_IMAGE . $this->request->post['config_mail_logo'])) {
			$data['mail_logo'] = $this->model_tool_image->resize($this->request->post['config_mail_logo'], 100, 100);
		} elseif ($this->config->get('config_mail_logo') && is_file(DIR_IMAGE . $this->config->get('config_mail_logo'))) {
			$data['mail_logo'] = $this->model_tool_image->resize($this->config->get('config_mail_logo'), 100, 100);
		} else {
			$data['mail_logo'] = $this->model_tool_image->resize('no_image.png', 100, 100);
		}

		if (isset($this->request->post['config_mail_background'])) {
			$data['config_mail_background'] = $this->request->post['config_mail_background'];
		} else {
			$data['config_mail_background'] = $this->config->get('config_mail_background');
		}

		if (isset($this->request->post['config_mail_background']) && is_file(DIR_IMAGE . $this->request->post['config_mail_background'])) {
			$data['mail_background'] = $this->model_tool_image->resize($this->request->post['config_mail_background'], 100, 100);
		} elseif ($this->config->get('config_mail_background') && is_file(DIR_IMAGE . $this->config->get('config_mail_background'))) {
			$data['mail_background'] = $this->model_tool_image->resize($this->config->get('config_mail_background'), 100, 100);
		} else {
			$data['mail_background'] = $this->model_tool_image->resize('no_image.png', 100, 100);
		}

		if (isset($this->request->post['config_mail_background_footer'])) {
			$data['config_mail_background_footer'] = $this->request->post['config_mail_background_footer'];
		} else {
			$data['config_mail_background_footer'] = $this->config->get('config_mail_background_footer');
		}

		if (isset($this->request->post['config_mail_background_footer']) && is_file(DIR_IMAGE . $this->request->post['config_mail_background_footer'])) {
			$data['mail_background_footer'] = $this->model_tool_image->resize($this->request->post['config_mail_background_footer'], 100, 100);
		} elseif ($this->config->get('config_mail_background_footer') && is_file(DIR_IMAGE . $this->config->get('config_mail_background_footer'))) {
			$data['mail_background_footer'] = $this->model_tool_image->resize($this->config->get('config_mail_background_footer'), 100, 100);
		} else {
			$data['mail_background_footer'] = $this->model_tool_image->resize('no_image.png', 100, 100);
		}

		// << Input color
		if (isset($this->request->post['config_mail_color_text'])) {
			$data['config_mail_color_text'] = $this->request->post['config_mail_color_text'];
		} elseif ($this->config->get('config_mail_color_text')) {
			$data['config_mail_color_text'] = $this->config->get('config_mail_color_text');
		} else {
			$data['config_mail_color_text'] = '#ffffff';
		}

		if (isset($this->request->post['config_mail_color_background'])) {
			$data['config_mail_color_background'] = $this->request->post['config_mail_color_background'];
		} elseif ($this->config->get('config_mail_color_background')) {
			$data['config_mail_color_background'] = $this->config->get('config_mail_color_background');
		} else {
			$data['config_mail_color_background'] = '#ffffff';
		}
		// Input color >>
		...
		// -------------------------------------------------------
		// SEO текст и картинку вывели в конфиги - вкладка Магазин
		if (isset($this->request->post['config_seo_image']) && is_file(DIR_IMAGE . $this->request->post['config_seo_image'])) {
			$data['thumb_seo'] = $this->model_tool_image->resize($this->request->post['config_seo_image'], 100, 100);
		} elseif ($this->config->get('config_seo_image') && is_file(DIR_IMAGE . $this->config->get('config_seo_image'))) {
			$data['thumb_seo'] = $this->model_tool_image->resize($this->config->get('config_seo_image'), 100, 100);
		} else {
			$data['thumb_seo'] = $this->model_tool_image->resize('no_image.png', 100, 100);
		}

		if (isset($this->request->post['config_seo_image'])) {
			$data['config_seo_image'] = $this->request->post['config_seo_image'];
		} else {
			$data['config_seo_image'] = $this->config->get('config_seo_image');
		}
		...
		$config_seo_text = array();
		$config_title_seo_text = array();

		foreach ($data['languages'] as $language) {
			$config_key = 'config_seo_text_' . $language['code'];
			if (isset($this->request->post[$config_key])) {
				$config_seo_text[$language['code']] = $this->request->post[$config_key];
			} else {
				$config_seo_text[$language['code']] = $this->config->get($config_key);
			}

			$config_key_title = 'config_title_seo_text_' . $language['code'];
			if (isset($this->request->post[$config_key_title])) {
				$config_title_seo_text[$language['code']] = $this->request->post[$config_key_title];
			} else {
				$config_title_seo_text[$language['code']] = $this->config->get($config_key_title);
			}
		}
		
		$data['config_seo_text'] = $config_seo_text;
		$data['config_title_seo_text'] = $config_title_seo_text;
		...
		// SEO URL
		if (isset($this->request->post['config_seo_url_my'])) {
			$data['config_seo_url_my'] = $this->request->post['config_seo_url_my'];
		} else {
			$data['config_seo_url_my'] = $this->config->get('config_seo_url_my');
		}

		if (isset($this->request->post['config_catagory_product'])) {
			$data['config_catagory_product'] = $this->request->post['config_catagory_product'];
		} else {
			$data['config_catagory_product'] = $this->config->get('config_catagory_product');
		}

		if (isset($this->request->post['config_catagory_product_position'])) {
			$data['config_catagory_product_position'] = $this->request->post['config_catagory_product_position'];
		} else {
			$data['config_catagory_product_position'] = $this->config->get('config_catagory_product_position');
		}

		if (isset($this->request->post['config_catagory_product_child'])) {
			$data['config_catagory_product_child'] = $this->request->post['config_catagory_product_child'];
		} else {
		...
		if (isset($this->request->post['config_cart_schedule'])) {
			$data['config_cart_schedule'] = $this->request->post['config_cart_schedule'];
		} else {
			$data['config_cart_schedule'] = $this->config->get('config_cart_schedule');
		}

		if (isset($this->request->post['config_cart_description_shipping'])) {
			$data['config_cart_description_shipping'] = $this->request->post['config_cart_description_shipping'];
		} else {
			$data['config_cart_description_shipping'] = $this->config->get('config_cart_description_shipping');
		}

		if (isset($this->request->post['config_cart_description_payment'])) {
			$data['config_cart_description_payment'] = $this->request->post['config_cart_description_payment'];
		} else {
			$data['config_cart_description_payment'] = $this->config->get('config_cart_description_payment');
		}

		if (isset($this->request->post['config_cart_description_comment'])) {
			$data['config_cart_description_comment'] = $this->request->post['config_cart_description_comment'];
		} else {
			$data['config_cart_description_comment'] = $this->config->get('config_cart_description_comment');
		}

		if (isset($this->request->post['config_cart_description_promo'])) {
			$data['config_cart_description_promo'] = $this->request->post['config_cart_description_promo'];
		} else {
			$data['config_cart_description_promo'] = $this->config->get('config_cart_description_promo');
		}
