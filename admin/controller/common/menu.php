...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['text_seo_titles'] = $this->language->get('text_seo_titles');
        ...
        $data['text_novaposhta'] = $this->language->get('text_novaposhta');
		...
		$data['faq_listing'] = $this->url->link('module/faq/listing', 'token=' . $this->session->data['token'], 'SSL');
		$data['faq_testimonial'] = $this->url->link('module/faq_testimonial/listing', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['service'] = $this->url->link('catalog/service', 'token=' . $this->session->data['token'], 'SSL');
		$data['promotags'] = $this->url->link('catalog/promotags', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['seo_titles'] = $this->url->link('tool/seo_titles', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['sproduct'] = $this->url->link('catalog/sproduct', 'token=' . $this->session->data['token'], 'SSL');
        $data['series'] = $this->url->link('catalog/series', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['reviews'] = $this->url->link('catalog/reviews', 'token=' . $this->session->data['token'], 'SSL');
        $data['novaposhta'] = $this->url->link('sale/novaposhta', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['link_vacansy'] = $this->url->link('catalog/vacansy', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['link_department'] = $this->url->link('sale/department', 'token=' . $this->session->data['token'], 'SSL');


		$data['catalog_news'] = $this->url->link('catalog/news', 'token=' . $this->session->data['token'], 'SSL');
		$data['catalog_ncategory'] = $this->url->link('catalog/ncategory', 'token=' . $this->session->data['token'], 'SSL');
		$data['catalog_ncomments'] = $this->url->link('catalog/ncomments', 'token=' . $this->session->data['token'], 'SSL');
		$data['catalog_nauthor'] = $this->url->link('catalog/nauthor', 'token=' . $this->session->data['token'], 'SSL');
		$data['catalog_ncategory_module'] = $this->url->link('module/ncategory', 'token=' . $this->session->data['token'], 'SSL');
		$data['catalog_news_module'] = $this->url->link('module/news', 'token=' . $this->session->data['token'], 'SSL');
