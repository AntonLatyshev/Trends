...
$(function () {
  ...
  // перенес код в checkout/checkout.tpl бо он только в корзине должен отрабатывать
   ...
   * только по id #new-customer(это в корзине) чтоб корзиновые поля обрабатывать
   **/
  $(document).on('change', '#new-customer input[name=\'firstname\'], #new-customer input[name=\'telephone\'], #new-customer input[name=\'email\'], #new-customer input[name=\'password\'], #new-customer textarea[name=\'comment\']', function() {
    var _this = $(this),
