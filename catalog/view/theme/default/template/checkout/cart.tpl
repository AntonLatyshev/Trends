...
<div class="cart-product-holder">
    <div class="cart-product-list">
        ...
        <div class="product-item">
            ...
            <span class="close-product-cart" onclick="cart.remove_checkout('<?php echo $product['key']; ?>');">&times;</span>
            <a href="<?php echo $product['href']; ?>" class="image">
                <img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" width="45" height="52">
            </a>
            <div class="info-box">
...
<!--                <div class="code">--><?php //echo $column_model . ' ' . $product['model']; ?><!--</div>-->
                <div class="info-row">
                    ...
                    <span class="edit" onclick="edit_cart(<?php echo $product['product_id']; ?>)"><?php echo $column_edit; ?></span>
...
<!--        <div class="cart-totals">-->
        <?php foreach ($totals as $total) { ?>
            <div class="cart-total"><em><?php echo $total['title']; ?>:</em> <span class="price"><?php echo $total['text']; ?></span></div>
        <?php } ?>
<!--        </div>-->
        <div class="promo">
