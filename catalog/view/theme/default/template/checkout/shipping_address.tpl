<?php foreach ($shipping_address_fields as $key => $value) { ?>
  <?php if ($key == 'city') { ?>
    <div class="row">
      ...
      <?php } elseif ($value == 'select') { ?>
        <select id="shipping_address_city" name="city" data-jcf="{&quot;wrapNative&quot;: false, &quot;wrapNativeOnMobile&quot;: false}">
  ...
  <?php if ($key == 'address_1') { ?>
    <div class="row">
      ...
      <?php } elseif ($value == 'select') { ?>
        <select name="address_1" data-jcf="{&quot;wrapNative&quot;: false, &quot;wrapNativeOnMobile&quot;: false}">
          <option value=""><?php echo $text_select; ?></option>
        </select>
      <?php } else { ?>
        <input type="text" name="address_1" value="<?php echo $address_1; ?>" placeholder="<?php echo $entry_address_1; ?>" />
