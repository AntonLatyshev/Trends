<div class="step-heading">
    ...
    <span class="label-cart"><?php echo $text_title; ?><?php if ( $step_second ) { ?> <a href="#" class="edit-contact active" onclick="editStepFirst(); return false;"><?php echo $text_edit; ?></a><?php } ?></span>
</div>
<?php if ( !$step_second ) { ?>
        ...
        <div class="cart-froms-tab" id="validate-customer">
            ...
            <div class="tab new-customer active" id="new-customer">
                <div class="row" id="type-account">
                    <label for="with-register" class="register">
                ...
                <div class="row city">
                    ...
                    <span class="city-example"><?php echo $text_example; ?>, <a><?php echo $text_example_city; ?></a></span>
                </div>
                <div class="row">
                    <input type="tel" name="telephone" value="<?php echo $telephone; ?>" placeholder="<?php echo $entry_telephone; ?>" autocomplete="off" />
                </div>
