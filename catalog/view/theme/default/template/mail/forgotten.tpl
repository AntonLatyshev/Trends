...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <td align="center">
            <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <table class="col-600" width="600" height="105" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td align="center" style="line-height: 0px;padding-top:25px;">
                                <img style="display:block; width: 80px;line-height:0px; font-size:0px; border:0px;" src="<?php echo $mail_logo; ?>" alt="<?php echo $config_name; ?>" />
                            </td>
                        </tr>
    ...
    <tr>
        <td align="center">
            <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-left:20px; margin-right:20px;">
                ...
                <tr>
                    <td align="center" class="text-size-20" style="font-family: 'Open Sans', sans-serif; font-size:22px; color:inherit; font-weight: 600; letter-spacing: 1px; padding: 0 10px;">
                        <?php echo $text_hello; ?>
                    </td>
                </tr>
                ...
                <tr>
                    <td align="center" class="text-size-14" style="font-family: 'Open Sans', sans-serif; font-size:18px; color:#333; line-height:1.4; font-weight: 400; padding: 0 10px;">
                        <?php echo $text_description_1 . ' ' . $config_name . ' ' . $text_description_2 . '' . $date; ?>.
                    </td>
                </tr>
                ...
                <tr>
                    <td align="center" class="text-size-14" style="font-family: 'Open Sans', sans-serif; font-size:20px; font-weight: bold; color:#ffcc00; padding: 0 15px">
                        <span style="color:#757575;font-size:18px;"><?php echo $text_password; ?></span> <?php echo $password; ?>
                    </td>
                </tr>
    ...
    <tr>
        <td align="center">
            <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="color:<?php echo $color_text; ?>;">
                <tr>
                    <td height="40"></td>
                </tr>
                <tr>
