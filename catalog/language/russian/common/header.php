<?php
// Text
$_['text_hell']         = 'Здравствуйте, %s!';
$_['desc_hell']         = 'Вы авторизовались!';
$_['text_home']          = 'Главная';
...
$_['text_call_free']    = 'Звонки с мобильного бесплатно';
$_['text_callme']       = 'Заказать обратный звонок';
$_['text_presentation'] = 'Заказать презентацию';
$_['text_career']       = 'Карьера';
$_['text_partners']     = 'Наши партнеры';
$_['text_request']      = 'Сделать заявку';
$_['text_affiliate']    = 'Стать партнером';
