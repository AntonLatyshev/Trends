...
$_['text_items']       = '<span class="basket_item">В корзине: <i>%s товар</i></span><span class="basket_sum"> на сумму %s</span>';
...
// Popup
$_['text_edit']           = 'Радактирование товара';
$_['text_model']          = 'Арт.';
$_['text_price']          = 'Ціна за од:';
$_['text_quantity']       = 'Кількість:';
$_['text_total']          = 'Разом:';
$_['text_add_success']    = 'доданий в кошик';


// Column
$_['column_image']          = 'Изображение';
$_['column_name']           = 'Назване';
$_['column_model']          = 'Арт.';
$_['column_edit']           = 'Редагувати';
$_['column_quantity']       = 'шт.';
$_['column_price']          = 'Цена за шт.';
$_['column_total']          = 'Всего';
$_['column_promo_handler']     = 'Ввести промокод';
$_['column_promo_placeholder'] = 'Введите промокод';
$_['column_promo_info']        = 'Lorem ipsum dolor sit amet, consectetur adipisicing elit mollit anim id est laborum.';
