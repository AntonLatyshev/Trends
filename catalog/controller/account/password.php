...
//		);
	...
	protected function validate() {
		...
		if(empty($this->request->post['old_password'])){
			$this->error['password_old'] = $this->language->get('error_password_old_empty');
		} else {
			$search_user = $this->model_account_customer->searchCustomer($this->request->post['old_password']);
			...
			if($search_user){
				...
				if($this->request->post['password'] == $this->request->post['old_password']){
					$this->error['password'] = $this->language->get('error_password_exist');
				} else {
				...
				$this->error['password_old'] = $this->language->get('error_password_not_found');
			}
		}
